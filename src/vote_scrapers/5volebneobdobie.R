...
URL_to_page = paste0("https://www.nrsr.sk/web/Default.aspx?sid=schodze/hlasovanie/hlasklub&ID=", "26985", collapse = NULL)
...
fwrite(total_df, file ="5volebneobdobie.csv")
