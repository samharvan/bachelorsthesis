...
URL_to_page = paste0("https://www.nrsr.sk/web/Default.aspx?sid=schodze/hlasovanie/hlasklub&ID=", "30003", collapse = NULL)
...
fwrite(total_df, file ="6volebneobdobie.csv")
